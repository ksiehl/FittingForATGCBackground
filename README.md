...
python prepare_bkg_oneCat_angles.py -b --channel el --readtrees --starangle CUTVALUE

python prepare_bkg_oneCat_angles.py -b --channel mu --readtrees --starangle CUTVALUE
-b: batch mode
-c: channel (el or mu)
